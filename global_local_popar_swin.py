...
def parse_option():
    ...
    parser.add_argument('--weight', dest='weight', default="/sda1/zhouziyu/ssl/NIHChestX-ray14/checkpoints/ssl_pretrained_weight/global_local_consis/last.pth")
    ...
    parser.add_argument('--output', type=str, default='/data/zhouziyu/ssl/NIHChestX-ray14/checkpoints/ssl_pretrained_weight/global_local_consis/')
...
def train(train_loader, student, teacher, momentum_schedule, optimizer, epoch, loss_scaler, conf, writer, log_writer):
    ...
    for idx, (patch1, patch2, gt_patch1, randperm, orderperm, index1, index2, shuffle) in enumerate(train_loader):
        ...
        #                 # b = (randperm[i]==index2[i, j]).nonzero()
        #                 actual_l+=1
